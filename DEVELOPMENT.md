...
```bash
git remote add encore encore://icrc1-token-creator-8au2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/icrc1-token-creator-8au2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/icrc1-token-creator-8au2/settings/integrations/github)
